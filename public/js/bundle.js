...
if (mapBox) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2lzdW11IiwiYSI6ImNsMHFtMmR2ZzAyY2UzY3VsMGJmeHlsZ2wifQ.0hAGydjBbM0feiMPTPrhDA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kisumu/cl0qpp9r0007w14qidk7ri5t1' //   center: [-118.113491, 34.111745],
    //   zoom: 10,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0.response.data.messsage);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51KhGlaHAWczgrlmq0kCEt8jCslPiXVDchiwSsnxvmK2LoZvI23r7oeKlvpL7zPk5aZ1IXTzC93Od96lyzprMPo0v004kWG8mvg');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'GET',
          ...
          case 4:
            ...
            console.log(session); // 2) Create chechoutform, charge credit card
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('photo', document.getElementById('photo').value)[0];
